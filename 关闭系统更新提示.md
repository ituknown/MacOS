...
<div style="text-align: left; ">
  <img src="https://media.ituknown.org/macos-media/disable_system_update/software-update.png" alt="software-update.png" width="650" />
</div>

**2）** 接着点击高级（Advanced），取消勾选自动更新检查。如下图：

<div style="text-align: left; ">
  <img src="https://media.ituknown.org/macos-media/disable_system_update/software-update-advice.png" alt="software-update-advice.png" width="650" />
</div>

这样以后就不会有更新提示了，但是在 Dock 中当前还是有个红点提示，看起来挺烦的。如下图：

<div style="text-align: left; ">
  <img src="https://media.ituknown.org/macos-media/disable_system_update/desktop-dock.png" alt="desktop-dock.png" width="650" />
</div>
